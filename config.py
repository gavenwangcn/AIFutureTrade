...
CLICKHOUSE_LEADERBOARD_CLEANUP_INTERVAL_MINUTES = int(os.getenv('CLICKHOUSE_LEADERBOARD_CLEANUP_INTERVAL_MINUTES', '10'))  # 涨跌榜清理执行频率（分钟）
CLICKHOUSE_LEADERBOARD_RETENTION_MINUTES = int(os.getenv('CLICKHOUSE_LEADERBOARD_RETENTION_MINUTES', '10'))  # 保留最近N分钟内的涨跌榜批次
