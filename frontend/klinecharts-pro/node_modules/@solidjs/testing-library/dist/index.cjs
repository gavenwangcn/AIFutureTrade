...
function render(ui, options = {}) {
  ...
  const wrappedUi = typeof wrapper === "function" ? () => (0, import_solid_js.createComponent)(wrapper, { get children() {
