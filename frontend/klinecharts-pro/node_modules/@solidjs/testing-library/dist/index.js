...
import { createComponent, createRoot, createSignal, getOwner, onMount } from "solid-js";
...
function render(ui, options = {}) {
  ...
  const wrappedUi = typeof wrapper === "function" ? () => createComponent(wrapper, { get children() {
