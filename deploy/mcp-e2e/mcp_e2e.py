...
环境变量：
  ...
  E2E_SKIP_MARKET      若为 1：跳过 trade_market_symbol_prices（仅测库表类 tool）
"""
...
TOOL_TICKERS_ALL_SYMBOLS = "trade_market_tickers_all_symbols"
TOOL_MARKET_SYMBOL_PRICES = "trade_market_symbol_prices"
