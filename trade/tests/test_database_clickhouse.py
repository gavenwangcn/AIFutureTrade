...
Run with:
    ...
    python trade/tests/test_database_clickhouse.py
    或
    python -m trade.tests.test_database_clickhouse

The script reuses the main MySQL configuration from trade.common.config and will
...
from trade.common.database.database_market_tickers import MarketTickersDatabase, MARKET_TICKER_TABLE
