...
class StrategyCodeTesterSell:
    ...
    def _test_imports(self, strategy_code: str) -> Dict:
        ...
        # 检查是否导入了 StrategyBaseSell
        if 'from trade.strategy.strategy_template_sell import StrategyBaseSell' not in strategy_code:
            if 'from trade.strategy_template_sell import StrategyBaseSell' in strategy_code:
                warnings.append("建议使用 'from trade.strategy.strategy_template_sell import StrategyBaseSell' 导入方式")
            elif 'import StrategyBaseSell' in strategy_code:
                warnings.append("建议使用 'from trade.strategy.strategy_template_sell import StrategyBaseSell' 导入方式")
            else:
                errors.append("未找到 StrategyBaseSell 导入语句，必须包含: from trade.strategy.strategy_template_sell import StrategyBaseSell")
