...
MYSQL_HOST = os.getenv('MYSQL_HOST', '156.254.6.224')  # MySQL server address (default: 156.254.6.224)
...
PROMPT_MARKET_SYMBOL_LIMIT = 15  # Number of market contracts processed each time model is called (from leaderboard)
