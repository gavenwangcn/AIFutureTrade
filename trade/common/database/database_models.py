        ...
        try:
            ...
            rows = self.query(f"""
                SELECT m.id, m.name, m.provider_id, m.model_name, m.initial_capital, 
                       ...
                       m.account_alias, m.is_virtual, m.symbol_source, m.trade_type, m.base_volume, m.daily_return, m.losses_num, m.created_at,
            ...
            columns = ["id", "name", "provider_id", "model_name", "initial_capital", 
                      ...
                      "account_alias", "is_virtual", "symbol_source", "trade_type", "base_volume", "daily_return", "losses_num", "created_at",
